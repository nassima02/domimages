...
function Galeries() {
	...
	const [categories, fetchCategories, loading] = useCategories(); // Ajoutez `loading`
...
// 			</Typography>
// 			<CategoryCards categories={categories} onCategoryClick={handleCategoryClick}/>
// 			<CategoryDialog open={openCategoryDialog} onClose={handleCloseCategoryDialog}
// 			                updateCategories={updateCategories} refreshCategories={fetchCategories}
// 			                categories={categories}/>
// 		</Box>
// 	);
// }
