			...
			<Box sx={{
				...
				<Box sx={{p: 2, mb: 3, width: '100%', order: {xs: 0, md: 1}}}>
					<Typography variant="body1" component="p">
						...
						Adhérent dans un club photo de ma région (Seine et Marne), qui m&apos;a guidé pour acquérir les
						bases de la photographie. En complément, j&apos;ai suivi quelques stages et une formation en
						ligne au
						...
						proposé de créer ce site, dont l’ambition est de partager mes photos et d’échanger avec les
						visiteurs de mon site, qui
